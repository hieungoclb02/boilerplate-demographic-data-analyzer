...
def calculate_demographic_data(print_data=True):
    ...
    table=df[df['salary']=='>50K']['native-country'].value_counts()/df['native-country'].value_counts()

    highest_earning_country = table.idxmax()
    highest_earning_country_percentage = round(table.max()*100,1)

    # Identify the most popular occupation for those who earn >50K in India.
    rich_indian=df[df['salary']=='>50K']
    rich_indian=rich_indian[rich_indian['native-country']=='India']
